...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Definity - F.A.Q Page - 1</title>
    ...
    <body id="page-top">
                  ...
                  <ul class="dropdown-menu">
                    <div class="row">
                      ...
                      <div class="col-lg-3 mb-sm-30">
                        ...
                        <li><a href="../index.html" target="_blank">Full Width Slider</a></li>
                      </div>
                  ...
                  <ul class="dropdown-menu">
                    <div class="row">
                      ...
                      <div class="col-lg-3 mb-sm-30">
                        ...
                        <li><a href="faq.html">F.A.Q. Page 1</a></li>
                        <li><a href="faq-2.html">F.A.Q. Page 2</a></li>
                        <li><a href="login.html">Login Page 1</a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown cart-nav">
                  ...
                  <ul class="dropdown-menu cart-dropdown">
                    ...
                    <li>
                      <div class="cart-item">
                        <a href="shop/shop-single.html"><img src="../assets/images/shop/p-thumb-1.jpg" alt="Product Name" class="p-thumb"></a>
                        <a href="#" class="cart-remove-btn"><span class="linea-arrows-square-remove"></span></a>
                        <a href="shop/shop-single.html" class="cp-name">Light Blue Suit</a>
                        <p class="cp-price">1 x $359.99</p>
                      </div>

                      <div class="cart-item">
                        <a href="shop/shop-single.html"><img src="../assets/images/shop/p-thumb-2.jpg" alt="Product Name" class="p-thumb"></a>
                        <a href="#" class="cart-remove-btn"><span class="linea-arrows-square-remove"></span></a>
                        <a href="shop/shop-single.html" class="cp-name">Dark Blue Suit</a>
                    ...
                    <li class="cart-btns">
                      <a href="shop/shop-checkout.html" class="btn-ghost btn-block">View Cart</a>
                      <a href="shop/shop-checkout.html" class="btn btn-block">Checkout</a>
                    </li>
        ...
        <header class="page-title pt-small">
          <div class="container">
            <div class="row">
              <h1 class="col-sm-6">F.A.Q.</h1>
        ...
        <section class="container section">
          ...
          <div class="row">
            <div class="col-md-offset-3 col-md-6">
              ...
              <!-- FAQ Accordion -->
              <div class="panel-group accordions-1" id="faq-accordion-1" role="tablist" aria-multiselectable="true">
                ...
                <div class="panel panel-default">
                  <div class="panel-heading" role="tab" id="heading-4">
                    <h4 class="panel-title">
                      <span class="collapsed" role="button" data-toggle="collapse" data-parent="#faq-accordion-1" href="#collapse-4" aria-expanded="false" aria-controls="collapse-4">
                        Example question in acordion ?
                      </span>
                    </h4>
                  </div>
                ...
                <div class="panel panel-default">
                  <div class="panel-heading" role="tab" id="heading-5">
                    <h4 class="panel-title">
                      <span class="collapsed" role="button" data-toggle="collapse" data-parent="#faq-accordion-1" href="#collapse-5" aria-expanded="false" aria-controls="collapse-5">
                        Example question in acordion ?
                      </span>
                    </h4>
                  </div>
                ...
                <div class="panel panel-default">
                  <div class="panel-heading" role="tab" id="heading-6">
                    <h4 class="panel-title">
                      <span class="collapsed" role="button" data-toggle="collapse" data-parent="#faq-accordion-1" href="#collapse-6" aria-expanded="false" aria-controls="collapse-6">
                        Example question in acordion ?
                      </span>
                    </h4>
                  </div>
                ...
                <div class="panel panel-default">
                  <div class="panel-heading" role="tab" id="heading-7">
                    <h4 class="panel-title">
                      <span class="collapsed" role="button" data-toggle="collapse" data-parent="#faq-accordion-1" href="#collapse-7" aria-expanded="false" aria-controls="collapse-7">
                        Example question in acordion ?
                      </span>
                    </h4>
                  </div>
                ...
                <div class="panel panel-default">
                  <div class="panel-heading" role="tab" id="heading-8">
                    <h4 class="panel-title">
                      <span class="collapsed" role="button" data-toggle="collapse" data-parent="#faq-accordion-1" href="#collapse-8" aria-expanded="false" aria-controls="collapse-8">
                        Example question in acordion ?
                      </span>
                    </h4>
                  </div>
              ...
              <span class="faq-contact-links"><i class="fa fa-info-circle"></i> If you have more questions <a href="#">contact us here.</a></span>
