              ...
              <ul class="nav navbar-nav navbar-right">
                  ...
                  <li class="dropdown cart-nav">
                      ...
                      <ul class="dropdown-menu cart-dropdown">
                          ...
                          <li class="cart-btns">
                            <a href="shop-checkout.php" class="btn-ghost-light btn-block">Checkout</a>
                          </li>
                      </ul>
                  </li>
                  <!-- / Cart -->
                  ...
                  <li class="dropdown">
                      ...
                      <ul class="dropdown-menu search-dropdown">
                          <li>
                              <form method="POST" action="search.php"><input type="text" name="search" id="search" class="form-control" value="Search..." onfocus="this.value='';"></form>
                          </li>
                      </ul>
                  </li>
                  <!-- / Search -->
