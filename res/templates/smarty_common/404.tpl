...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Definity - 404 | Not Found</title>
                  ...
                  <ul class="dropdown-menu">
                    <div class="row">
                      ...
                      <div class="col-lg-3 mb-sm-30">
                        ...
                        <li role="separator" class="divider"></li>
                        <li><a href="pages/contact.html">Contact Page 1</a></li>
                      ...
                      <div class="col-lg-3 mb-sm-30">
                        ...
                        <li><a href="pages/faq.html">F.A.Q. Page 1</a></li>
                        <li><a href="pages/faq-2.html">F.A.Q. Page 2</a></li>
                        <li><a href="pages/login.html">Login Page 1</a></li>
        ...
        <div class="wrapper-404">
          <div class="content-wrapper">
            ...
            <ul class="links-404">
              ...
              <li><a href="pages/contact.html" class="btn-ghost-light btn-small">Report this</a></li>
            </ul>
